...
const PRODUCTION_NAME = 'difft-desktop';
const BETA_NAME = 'difft-desktop-beta';

const PRODUCT_NAME_PATH = 'productName';
const PRODUCTION_PRODUCT_NAME = 'Difft';
const BETA_PRODUCT_NAME = 'Difft Beta';

const APP_ID_PATH = 'build.appId';
const PRODUCTION_APP_ID = 'com.optillel.difft-desktop';
const BETA_APP_ID = 'com.optillel.difft-desktop-beta';

const STARTUP_WM_CLASS_PATH = 'build.linux.desktop.StartupWMClass';
const PRODUCTION_STARTUP_WM_CLASS = 'Difft';
const BETA_STARTUP_WM_CLASS = 'Difft Beta';
