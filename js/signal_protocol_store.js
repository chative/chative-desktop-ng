...
(function () {
  ...
  SignalProtocolStore.prototype = {
    ...
    // updateUnprocessedRequiredProtocolVersion(id, requiredProtocolVersion) {
    //   return window.Signal.Data.updateUnprocessedRequiredProtocolVersion(
    //     id,
    //     requiredProtocolVersion
    //   );
    // },
    removeUnprocessed(ids) {
      return window.Signal.Data.removeUnprocessed(ids);
    },
    removeAllUnprocessed() {
      return window.Signal.Data.removeAllUnprocessed();
    },
    deduplicateUnprocessed() {
      return window.Signal.Data.deduplicateUnprocessed();
    },
    getUnprocessedDuplicatedCount() {
      return window.Signal.Data.getUnprocessedDuplicatedCount();
    },
    async removeAllData() {
