...
function hexFromBinary(binary) {
  return dcodeIO.ByteBuffer.wrap(binary, 'binary').toString('hex');
}
function binaryFromHex(string) {
  return dcodeIO.ByteBuffer.wrap(string, 'hex').toString('binary');
}

function base64Encode(binary) {
  return dcodeIO.ByteBuffer.wrap(binary, 'binary').toString('base64');
}

function base64Decode(base64string) {
  return dcodeIO.ByteBuffer.wrap(base64string, 'base64').toString('binary');
}
