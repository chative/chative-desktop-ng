...
export const EmailVerifySideView = () => {
  ...
  if (errorid === 1001) {
    return (
      <div className={'email-verify-sideview'}>
        <div>
  ...
  if (errorid === 200) {
    return (
      <div className={'email-verify-sideview'}>
        <div>
          <img className={'logo-comman'} src="./images/LOGO.svg" />
        </div>
  ...
  return (
    <div className={'email-verify-sideview'}>
      ...
      <p className={'paragraph'}>please enter the code in chative to</p>
      <p className={'paragraph'}>verify your account.</p>
      <div className={'timer'}>
        <Countdown
