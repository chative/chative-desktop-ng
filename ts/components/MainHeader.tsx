...
// 测试服 approval 的  appId， 正式服需要替换正式的 appId
// const APPROVAL_APP_ID = 'b4933e7b0c12f9c16a'; // 测试服
// const APPROVAL_APP_ID = '2f2bfb4316100e9ea997'; // 正式服
...
export class MainHeader extends React.Component<Props, State> {
  ...
  constructor(props: Props) {
    ...
    this.state = {
      miniProgramList: [], // 纯用于是否展示 approval 入口按钮。
  ...
  public hasApprovalService() {
    ...
    // 根据写死的 approval 的 appId 找出对应的  httpUrl
    let httpUrl = '';
