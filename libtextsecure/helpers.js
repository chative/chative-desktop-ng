...
// max depth of forwards excluding message itself
// please note that, when displaying message,
// message itself could be treated as 1st layer
// so we can go into history's depth up to 3.
window.textsecure.MAX_FORWARD_DEPTH = 3;
